...
import { ADD_NOTE, ADD_STEPS, EDIT_TODO_ITEM, SET_DUE_DATE, SET_REMINDER, SET_REPEATING, TOGGLE_ADD_TO_MY_DAY } from '../reducer'
  ...
  return (
    ...
    <section className='detailed-todo-section'>
          <article className='detailed-todo-elements'>
            ...
            <article className='completion-status'>
                {activeTodo[0].completed ? <svg className='checked-filled' xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/></svg> : <article className='incomplete-icons'>
                <div className='first'>
                <svg className='checked-hollow' xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"/></svg>
                </div>
                <div className='second'>
                <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><path d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"/></svg>
                </div>
              ...
              <textarea type="text" value={activeTodo[0].inputText}  onChange={handleDetailedInput} cols={18} />
              </article>

              <article className='importance-status'>
              {activeTodo[0].important ? <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg> :
              <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 576 512"><path d="M287.9 0c9.2 0 17.6 5.2 21.6 13.5l68.6 141.3 153.2 22.6c9 1.3 16.5 7.6 19.3 16.3s.5 18.1-5.9 24.5L433.6 328.4l26.2 155.6c1.5 9-2.2 18.1-9.7 23.5s-17.3 6-25.3 1.7l-137-73.2L151 509.1c-8.1 4.3-17.9 3.7-25.3-1.7s-11.2-14.5-9.7-23.5l26.2-155.6L31.1 218.2c-6.5-6.4-8.7-15.9-5.9-24.5s10.3-14.9 19.3-16.3l153.2-22.6L266.3 13.5C270.4 5.2 278.7 0 287.9 0zm0 79L235.4 187.2c-3.5 7.1-10.2 12.1-18.1 13.3L99 217.9 184.9 303c5.5 5.5 8.1 13.3 6.8 21L171.4 443.7l105.2-56.2c7.1-3.8 15.6-3.8 22.6 0l105.2 56.2L384.2 324.1c-1.3-7.7 1.2-15.5 6.8-21l85.9-85.1L358.6 200.5c-7.8-1.2-14.6-6.1-18.1-13.3L287.9 79z"/></svg>
            ...
            <ul>
            {activeTodo[0].todosDetails.steps.map((step, idx)=><li key={activeTodo[0].id + 10255 + idx}>
            ...
            <article className='step-text'><p>{step}</p> <hr /></article>
            <article className="steps-icon steps-menu-icon">
            ...
            <button className='add-step-btn' type='button' onClick={handleStepSubmit}>
            <svg xmlns="http://www.w3.org/2000/svg" height="18" width="18" viewBox="0 0 448 512"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg>
            </button>
          ...
          <article className="detailed-todo-elements" onClick={addToMyDay}>
              <article className="add-to-my-day">{activeTodo[0]?.todosDetails.isInMyDay?
               <div className='in-my-day'><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><path d="M361.5 1.2c5 2.1 8.6 6.6 9.6 11.9L391 121l107.9 19.8c5.3 1 9.8 4.6 11.9 9.6s1.5 10.7-1.6 15.2L446.9 256l62.3 90.3c3.1 4.5 3.7 10.2 1.6 15.2s-6.6 8.6-11.9 9.6L391 391 371.1 498.9c-1 5.3-4.6 9.8-9.6 11.9s-10.7 1.5-15.2-1.6L256 446.9l-90.3 62.3c-4.5 3.1-10.2 3.7-15.2 1.6s-8.6-6.6-9.6-11.9L121 391 13.1 371.1c-5.3-1-9.8-4.6-11.9-9.6s-1.5-10.7 1.6-15.2L65.1 256 2.8 165.7c-3.1-4.5-3.7-10.2-1.6-15.2s6.6-8.6 11.9-9.6L121 121 140.9 13.1c1-5.3 4.6-9.8 9.6-11.9s10.7-1.5 15.2 1.6L256 65.1 346.3 2.8c4.5-3.1 10.2-3.7 15.2-1.6zM160 256a96 96 0 1 1 192 0 96 96 0 1 1 -192 0zm224 0a128 128 0 1 0 -256 0 128 128 0 1 0 256 0z"/></svg> <p>  Add to my day</p></div>
                :
                <div className='not-in-my-day'>
              <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512"><path d="M375.7 19.7c-1.5-8-6.9-14.7-14.4-17.8s-16.1-2.2-22.8 2.4L256 61.1 173.5 4.2c-6.7-4.6-15.3-5.5-22.8-2.4s-12.9 9.8-14.4 17.8l-18.1 98.5L19.7 136.3c-8 1.5-14.7 6.9-17.8 14.4s-2.2 16.1 2.4 22.8L61.1 256 4.2 338.5c-4.6 6.7-5.5 15.3-2.4 22.8s9.8 13 17.8 14.4l98.5 18.1 18.1 98.5c1.5 8 6.9 14.7 14.4 17.8s16.1 2.2 22.8-2.4L256 450.9l82.5 56.9c6.7 4.6 15.3 5.5 22.8 2.4s12.9-9.8 14.4-17.8l18.1-98.5 98.5-18.1c8-1.5 14.7-6.9 17.8-14.4s2.2-16.1-2.4-22.8L450.9 256l56.9-82.5c4.6-6.7 5.5-15.3 2.4-22.8s-9.8-12.9-17.8-14.4l-98.5-18.1L375.7 19.7zM269.6 110l65.6-45.2 14.4 78.3c1.8 9.8 9.5 17.5 19.3 19.3l78.3 14.4L402 242.4c-5.7 8.2-5.7 19 0 27.2l45.2 65.6-78.3 14.4c-9.8 1.8-17.5 9.5-19.3 19.3l-14.4 78.3L269.6 402c-8.2-5.7-19-5.7-27.2 0l-65.6 45.2-14.4-78.3c-1.8-9.8-9.5-17.5-19.3-19.3L64.8 335.2 110 269.6c5.7-8.2 5.7-19 0-27.2L64.8 176.8l78.3-14.4c9.8-1.8 17.5-9.5 19.3-19.3l14.4-78.3L242.4 110c8.2 5.7 19 5.7 27.2 0zM256 368a112 112 0 1 0 0-224 112 112 0 1 0 0 224zM192 256a64 64 0 1 1 128 0 64 64 0 1 1 -128 0z"/></svg>
              <p >Add to my day</p></div>}
              </article>
          </article>
            ...
            <ul className='set-schedule'>
              ...
              <li className='detailed-customs'>
                  ...
                  {activeTodo[0].todosDetails.dueDate.isDue ?
                    <article className='reminder-display'>
                        <span>
                          {`Due  ${activeTodo[0].todosDetails.dueDate.type == "today" ? 'Today':
                          activeTodo[0].todosDetails.dueDate.type == "tommorow" ? 'Tommorow':
                          activeTodo[0].todosDetails.dueDate.type == "Next week" ? 'Next week':
                          activeTodo[0].todosDetails.dueDate.type == "custom" ? activeTodo[0].todosDetails.dueDate.dueDate
                          :
                          '' }`}
                        </span>
                  ...
                  {( selected.dueDate ?
                    <article className='detailed-set-reminders'>
                      <ul>
                          ...
                          <li onClick={()=>dueDateOptions("later today")}>Later today</li>
                          <li onClick={()=>dueDateOptions("tommorow")}>Tommorow </li>
                          <li onClick={()=>dueDateOptions("next week")}>Next week</li>
                          <li onClick={handleCustomDueDate}>Set date and time</li>
                      </ul>
                    </article> : customReminder.dueDate?
                    <article className='custom-reminder detailed-set-reminders'>
                      <DatePicking
                      activeTodo={activeTodo}
              ...
              <li className='detailed-customs'>
                ...
                <label htmlFor='repeat'>
                  <article className='schedulings'>
                  <article className='scheduling-icon'>
                  <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path d="M0 224c0 17.7 14.3 32 32 32s32-14.3 32-32c0-53 43-96 96-96H320v32c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l64-64c12.5-12.5 12.5-32.8 0-45.3l-64-64c-9.2-9.2-22.9-11.9-34.9-6.9S320 19.1 320 32V64H160C71.6 64 0 135.6 0 224zm512 64c0-17.7-14.3-32-32-32s-32 14.3-32 32c0 53-43 96-96 96H192V352c0-12.9-7.8-24.6-19.8-29.6s-25.7-2.2-34.9 6.9l-64 64c-12.5 12.5-12.5 32.8 0 45.3l64 64c9.2 9.2 22.9 11.9 34.9 6.9s19.8-16.6 19.8-29.6V448H352c88.4 0 160-71.6 160-160z"/></svg>
                  </article>
                  ...
                  {activeTodo[0].todosDetails.repeat.isRepeating ?
                    <article className='reminder-display'>
                        <span>
                          {`${
                          activeTodo[0].todosDetails.repeat.frequency == "Daily" ? 'Daily':
                          activeTodo[0].todosDetails.repeat.frequency == "Weekdays" ? 'Weekdays':
                          activeTodo[0].todosDetails.repeat.frequency == "Weekly" ? 'Weekly':
                          activeTodo[0].todosDetails.repeat.frequency == "Monthly" ? "Monthly":
                          activeTodo[0].todosDetails.repeat.frequency == "Yearly" ? "Yearly"
                          :
                          '' }`}
                        </span>
                  ...
                  {( selected.repeat ?
                    <article className='detailed-set-reminders'>
                      <ul>
                          ...
                          <li onClick={()=>repeatOptions("Weekdays")}>weekdays </li>
          ...
          <article className='detailed-todo-elements'>
              <textarea value={note} onChange={handleAddNote}  rows="4" cols="20">
              </textarea>
          </article>

          <article className="detailed-delete">
